 ...
 */
class ApprovePaymentMobilePaymentMethodSpecificOutput extends DataObject
{
    /**
     * @var string|null
     */
     ...
     */
    public function fromObject(object $object): ApprovePaymentMobilePaymentMethodSpecificOutput
    {
