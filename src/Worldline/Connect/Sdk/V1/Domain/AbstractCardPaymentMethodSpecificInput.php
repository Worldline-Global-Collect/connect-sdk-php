...
class AbstractCardPaymentMethodSpecificInput extends AbstractPaymentMethodSpecificInput
{
     ...
     * @var string|null
     */
    public ?string $acquirerPromotionCode = null;
     ...
     */
    public ?string $unscheduledCardOnFileIndicator = null;
     ...
     */
    public function fromObject(object $object): AbstractCardPaymentMethodSpecificInput
    {
